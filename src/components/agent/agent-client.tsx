  ...
  return (
    <div className="h-full overflow-y-auto">
      ...
      <div className="grid gap-6 p-6 lg:grid-cols-2 lg:items-start">
        ...
        {/* Columna Derecha: Knowledge base (Full Height) */}
        <div>
  ...
  return (
    <Card className="border-primary/20 bg-gradient-to-br from-background via-background to-primary/5">
      <CardHeader className="pb-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div>
              <CardTitle className="text-base">Cobertura NAP Integrada</CardTitle>
              <CardDescription className="text-xs">
                Verificación de coordenadas GPS por calles (OSRM)
              </CardDescription>
            </div>
          </div>
      ...
      <CardContent className="space-y-3 text-xs text-muted-foreground">
        <p>
          El agente evalúa automáticamente la ubicación de los clientes al recibir
          coordenadas GPS o enlaces de Google Maps en WhatsApp, verificando la distancia real
          hacia tus Cajas NAP activas (Umbral estándar: 300m por calles).
        </p>
        <div className="flex items-center justify-between rounded-md border bg-muted/40 p-2.5">
          <span className="font-medium text-foreground">Gestión de Cajas NAP</span>
          <Link href="/coverage">
            <Button size="sm" variant="outline" className="h-8 text-xs">
              Ver mapa y cajas NAP
            </Button>
          </Link>
        </div>
      </CardContent>
